...
class DistributingProtocolFactory(protocol.Factory):
    ...
    def buildProtocol(self, addr):
        ...
        log.msg('DistributingProtocolFactory: buildProtocol: Built distributing protocol %(p)s', p=protocol, logLevel=_TRACE)
        return protocol
...
class DistributingTransport:
    ...
    def getPeer(self):
        log.msg("DistributingTransport: getPeer: Delegate to transport %(t)s", t=self._transport, logLevel=_TRACE)
        return self._transport.getPeer()
    
    
    def getHost(self):
        log.msg("DistributingTransport: getHost: Delegate to transport %(t)s", t=self._transport, logLevel=_TRACE)
